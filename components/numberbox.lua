...
function NumberBox.new(opts)
  ...
  local minus, minusImg = stepBtn("Minus", "minus", UDim2.new(0, 3, 0.5, -12))
  local plus, plusImg = stepBtn("Plus", "plus", UDim2.new(1, -29, 0.5, -12))
  ...
  local function dim(img, off)
    ...
    dimmed[img] = off
    Animate.to(img, "fast", { ImageTransparency = off and theme.Opacity.disabled or 0 })
  end
